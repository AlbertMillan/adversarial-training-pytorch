...
# (STANDART : FGSM)
python train.py --mode 1 --att 1 --train_mode 0 --test_mode 1 --train_max_iter 0 --test_max_iter 1 --load_dir "model_chkpt_new/chkpt_plain/" --load_adv_dir "model_chkpt_new/chkpt_plain/" --gpu "1,3"

# (STANDART : PGD20)
python train.py --mode 1 --att 1 --train_mode 0 --test_mode 1 --train_max_iter 0 --test_max_iter 20 --load_dir "model_chkpt_new/chkpt_plain/" --load_adv_dir "model_chkpt_new/chkpt_plain/" --gpu "1,3"

# (STANDART : PGD100)
python train.py --mode 1 --att 1 --train_mode 0 --test_mode 1 --train_max_iter 0 --test_max_iter 100 --load_dir "model_chkpt_new/chkpt_plain/" --load_adv_dir "model_chkpt_new/chkpt_plain/" --gpu "1,3"

# (STANDART : MIM)
python train.py --mode 1 --att 1 --train_mode 0 --test_mode 1 --train_max_iter 0 --test_max_iter 20 --adv_momentum 1.0 --load_dir "model_chkpt_new/chkpt_plain/" --load_adv_dir "model_chkpt_new/chkpt_plain/" --gpu "1,3"
...
# (PGD7 : MIM)
python train.py --mode 1 --att 1 --train_mode 0 --test_mode 1 --train_max_iter 0 --test_max_iter 20 --adv_momentum 1.0 --load_dir "model_chkpt_new/chkpt_pgd7/" --load_adv_dir "model_chkpt_new/chkpt_plain/" --gpu "1,3"
...
# (PGD7 : MIM)
python train.py --mode 1 --att 1 --train_mode 0 --test_mode 1 --train_max_iter 0 --test_max_iter 20 --adv_momentum 1.0 --load_dir "model_chkpt_new/chkpt_pgd1/" --load_adv_dir "model_chkpt_new/chkpt_plain/" --gpu "1,3"
